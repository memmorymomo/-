...
-->
    ...
    <div class="page-content">
      <div class="wrapper">
                                    ...
                                    <div class="tab-contant">
                                      <div class="tab-pane" id="mall.html">    </div>
                                            <div class=" container">
                                              <div class="jumbotron">
                                                <H1 align="center"><font face = "kunlasatri"> ห้างสรรพสินค้า</h1></font>
                                              </div>

                                              <ol class="breadcrumb">
                                                                  <li><a href="index.html">ประจวบคีรีขันธ์</a>                    </li>
                                                                  <li><a href="#">แหล่งช้อปปิ้ง</a></li>
                                                                  <li class="active">ห้างสรรพสินค้า</li>
                                                                </ol>

                                                <h2 align="center"><font face = "kunlasatri"> ห้างสรรพสินค้า</h2></font>
  ...
  <footer role="contentinfo" style="background-color:#FF6666">
     <div class="grid">
       ...
       <div class="unit two-thirds align-right center-on-mobiles">
         <p>
           by
           <a href="https://github.com/memmorymomo/prachuapkhirikhan">
             <img src="/img/git.jpg" width="100" height="50" alt="GitHub • Social coding">&nbsp; &nbsp;&nbsp; &nbsp;
           </a>
         </p>
       </div>
       </div>
