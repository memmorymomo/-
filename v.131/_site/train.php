    ...
    <div class="page-content">
      <div class="wrapper">
                              ...
                              <div class="tab-contant">
                                <div class="tab-pane" id="train.html">    </div>
                                      <div class=" container">
                                        <div class="jumbotron">
                                          <H1 align="center"><font face = "kunlasatri"> การเดินทางโดยรถไฟ</h1></font>
                                          </div>

                                              <ol class="breadcrumb">
                                                                  <li><a href="index.html">ประจวบคีรีขันธ์</a>                    </li>
                                                                  <li><a href="#">การเดินทาง</a></li>
                                                                  <li class="active">รถไฟ</li>
                                                                </ol>



                                            <div class="col-md-5">
                                            <img class="featurette-image img-responsive pull-left"img src="img/train.gif" alt="..." width="250" Height="300" >
                                        </div>
                                          <h2 ><font face = "kunlasatri"><p style="text-indent: 2.5em;">จากสถานีรถไฟหัวลำโพงมีบริการขบวนรถไฟสายใต้ผ่านหัวหิน ปราณบุรีและประจวบคีรีขันธ์ ทุกวัน รถไฟท้องถิ่นมีขบวนรถกรุงเทพฯ-หัวหิน ออกจากกรุงเทพฯ 09.25 น.
                                             ถึงหัวหิน 13.45 น. และวันเสาร์-อาทิตย์และวันหยุดนักขัตฤกษ์ <br><p style="text-indent: 2.5em;">มีขบวนรถนำเที่ยวสวนสนประดิพัทธ์แบบเช้าไปเย็นกลับหรือ จากสถานีรถไฟธนบุรี มีขบวนรถไฟธนบุรี-หลังสวน ออกเวลา 07.20 น. ถึงหัวหิน 11.52 น.
                                             สอบถามเพิ่มเติมได้ที่ หน่วยบริการเดินทาง การรถไฟแห่งประเทศไทย โทร. 1690, 0 2220 4334 หรือ www.railway.co.th </h2></font>
