    ...
    <div class="page-content">
      <div class="wrapper">
                              ...
                              <div class="tab-contant">
                                <div class="tab-pane" id="car.html">    </div>
                                      <div class=" container">
                                        <div class="jumbotron">
                                          <H1 align="center"><font face = "kunlasatri"> การเดินทางโดยรถยนต์ส่วนตัว</h1></font>
</div>
                                              ...
                                              <ol class="breadcrumb">
                                                                  ...
                                                                  <li class="active">รถยนต์ส่วนตัว</li>
                                                                </ol>

                                            <div class="col-md-5">
                                              <img class="featurette-image img-responsive pull-left"img src="img/car.gif" alt="..." width="300" Height="200" >
                                        </div>
                                          <h2><font face = "kunlasatri"> จากกรุงเทพฯ สามารถเดินทางได้ 2 เส้นทาง คือ<br><p style="text-indent: 2.5em;"> เส้นทางแรก ใช้เส้นทางสายธนบุรี-ปากท่อ (ทางหลวงหมายเลข 35) ผ่านจังหวัดสมุทรสาคร สมุทรสงครามแล้วเลี้ยวซ้ายเข้าถนนเพชรเกษม (ทางหลวงหมายเลข 4) ผ่านจังหวัดเพชรบุรี เข้าสู่ตัวจังหวัดประจวบคีรีขันธ์
                                             รวมระยะทางประมาณ 280 กิโลเมตร ใช้เวลาเดินทางประมาณ 3 ชั่วโมงครึ่ง</h2></font></p>
                                          <h2><font face = "kunlasatri"><p style="text-indent: 2.5em;">เส้นทางที่สอง ใช้เส้นทางสายเพชรเกษม ทางหลวงหมายเลข 4 ผ่านพุทธมณฑล นครปฐม ราชบุรี เพชรบุรี
                                              เข้าสู่จังหวัดประจวบคีรีขันธ์ รวมระยะทางประมาณ 320 กิโลเมตร ใช้เวลาเดินทางประมาณ 4 ชั่วโมง</h2></font></p>
